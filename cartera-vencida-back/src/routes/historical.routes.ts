...
import { deleteHistorico, getHistoricoById, getHistoricos, getHistoricosBodegas, getHistoricosByCIU, getHistoricosPuestos, newHistorico, updateHistorico } from '../controllers/historical.controller';
